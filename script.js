...
function init() {
    ...
    if (self.location.host == "cloud.yandex.ru") {
        ...
        speed.value = 1
        audio.volume = 0.7
        token.value = "6796357d369398e766d1abb2f8b16fad9f20575b:1586284046"
        ...
        lang.children[2].innerHTML = "netral"
    ...
    pitch.onmousemove =()=>pitchView.innerText = pitch.value
    speed.onmousemove =()=>speedView.innerText = speed.value
    prov.onclick = () => {
        audioArr = []
...
function speakRus(mess, prov) {
    ...
    return new Promise((res, rej) => {
        ...
        fetch("https://cloud.yandex.ru/api/speechkit/tts", {
            ...
            .then(data => {
                if (data.constructor === String) log.innerHTML = data;
                else {
...
function speakEng(mess, prov) {
    ...
    let bodyGoogle = {
        ...
        {
            "languageCode": "en-US",
            "name": voice.selectedOptions[0].innerText
        },
        "audioConfig":
        {
